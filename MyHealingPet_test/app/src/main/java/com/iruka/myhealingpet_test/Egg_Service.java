...
public class Egg_Service extends Service {
    ...
    private View.OnTouchListener mViewTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            WindowManager.LayoutParams layoutParams = (WindowManager.LayoutParams) eggLayout.getLayoutParams();
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if(time_end - time_start > 150) egg.setImageResource(R.drawable.egg);
                    ...
                    windowManager.updateViewLayout(eggLayout, layoutParams);
                    break;
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    } else if (y_cord_Destination + (eggLayout.getHeight() + BarHeight) > szWindow.y) {
                        y_cord_Destination = szWindow.y - (eggLayout.getHeight() + BarHeight);
                    }
                    layoutParams.y = y_cord_Destination;
                    ...
                    if((time_end - time_start) > 45 && (time_end - time_start) < 300) {
                        ...
                        normalTalk();
                        egg.setImageResource(R.drawable.frame_egg);
                        mAni = (AnimationDrawable) egg.getDrawable();
                        mAni.start();
    ...
    public void onCreate() {
        ...
        eggLayout = (RelativeLayout) inflater.inflate(R.layout.egg_service_layout, null);
        egg = (ImageView)eggLayout.findViewById(R.id.egg_img);
        eggLayout.setOnTouchListener(mViewTouchListener);
        ...
        params.x = 0;
        params.y = 1000;
        windowManager.addView(eggLayout, params);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            if (layoutParams.y + (eggLayout.getHeight() + getStatusBarHeight()) > szWindow.y) {
                layoutParams.y = szWindow.y - (eggLayout.getHeight() + getStatusBarHeight());
                windowManager.updateViewLayout(eggLayout, layoutParams);
            }
    ...
    private void moveToLeft(int x_cord_now) {
        ...
        new CountDownTimer(500, 5) {
            WindowManager.LayoutParams mParams = (WindowManager.LayoutParams) eggLayout.getLayoutParams();

            public void onTick(long t) {
                long step = (500 - t) / 5;
                mParams.x = (int) (double) bounceValue(step, x);
                windowManager.updateViewLayout(eggLayout, mParams);
            }
    ...
    private void moveToRight(int x_cord_now) {
        ...
        new CountDownTimer(500, 5) {
            ...
            public void onTick(long t) {
                long step = (500 - t) / 5;
                mParams.x = szWindow.x + (int) (double) bounceValue(step, x) - eggLayout.getWidth();
                windowManager.updateViewLayout(eggLayout, mParams);
            }

            public void onFinish() {
                mParams.x = szWindow.x - eggLayout.getWidth();
                windowManager.updateViewLayout(eggLayout, mParams);
            }
        }.start();
    }
    ...
    private void showMsg(String sMsg) {
        if (txtView != null && eggLayout != null) {
            txt.setText(sMsg);
            myHandler.removeCallbacks(myRunnable_text);

            WindowManager.LayoutParams param_chathead = (WindowManager.LayoutParams) eggLayout.getLayoutParams();
            WindowManager.LayoutParams param_txt = (WindowManager.LayoutParams) txtView.getLayoutParams();

            txt_linearlayout.getLayoutParams().height = eggLayout.getHeight();
            txt_linearlayout.getLayoutParams().width = szWindow.x / 2;

            if (isLeft) {
                param_txt.x = param_chathead.x + egg.getWidth() - 100;
    ...
    public void onDestroy() {
        super.onDestroy();
        if(eggLayout != null){
            windowManager.removeView(eggLayout);
        }
