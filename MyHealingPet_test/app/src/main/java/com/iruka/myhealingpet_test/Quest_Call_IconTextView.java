...
public class Quest_Call_IconTextView extends LinearLayout {
	...
	public Quest_Call_IconTextView(Context context, Quest_Call_IconTextItem aItem) {
		super(context);

		// Layout Inflation
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.quest_call_listitem, this, true);
